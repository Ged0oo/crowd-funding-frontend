...
const AuthPage = () => {
  ...
  const { mutate: authenticateWithDjango, isPending } = useGoogleAuth();

  const navigate = useNavigate();
  const loginWithGoogle = useGoogleLogin({
    onSuccess: (tokenResponse) => {
      console.log("Got token from Google!", tokenResponse.access_token);
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex gap-8 mb-10 border-b border-outline-variant/20">
              <button
                ...
                className={`pb-4 text-lg font-bold transition-all border-b-2 ${activeTab === "login"
              ...
              <button
                ...
                className={`pb-4 text-lg font-bold transition-all border-b-2 ${activeTab === "register"
                  ? "border-primary text-primary"
                  : "border-transparent text-secondary hover:text-primary"
                  }`}
              >
            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-1 gap-4">
                <button
                  ...
                  disabled={isPending}
                  className="flex items-center justify-center gap-3 py-3 border border-outline-variant/30 rounded-xl hover:bg-surface-container-low transition-all"
                >
